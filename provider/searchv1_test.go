...
func ExampleSearchV1() {
	...
	buf, h, status := searchv1[core.Output](nil, req.Header, req.URL.Query())
...
func ExampleSearchV1_Timeout() {
	...
	defer cancel()
	_, _, status := searchv1[core.Output](ctx, req.Header, req.URL.Query())
